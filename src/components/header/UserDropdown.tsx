    ...
    <div className="relative">
      ...
      >
        <div>
          ...
          {role && (
            <span className="mt-1 inline-block px-2 py-1 text-theme-xs font-medium text-blue-600 bg-blue-50 rounded-full dark:bg-blue-900/20 dark:text-blue-400">
              {getFormattedRole()}
            </span>
          )}
        </div>
